									...
									<div class="col-md-5">
										...
										<tbody>
											<tr>
												...
												<div class="row">
													<div class="col-md-5">
														<button class="btn btn-default" onclick="location='share_new_req'">정보 등록</button>
													</div>
												</div>
												</td>
											</tr>
											<tr>
												...
												<div class="row">
												<div class="col-9">
													<input type="text" class="form-control" id="" value="2020년 5월 31일">
												</div>
												</div>
												</td>
											</tr>
											<tr>
												<th colspan="2">
													<button class="btn btn-primary" onclick="location='share_new_check'">확인</button>
												</th>
											</tr>
										</tbody>
									</table>
