...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
			...
			<div class="content">
				...
				<!--대출 신청   -->
		<form action="fileuploadvv" method="post" class="form-horizontal" enctype="multipart/form-data">
				<div class="row mt--4">
										...
										<div class="row">
											...
											<div class="col-10">
												...
												<div class="form-group row">
													...
													<div class="col-8">
														<input type="file" name="lf_oriname" >
														<input type="hidden" value="${e.filename }" name="lf_name">
													</div>
												</div>
												</c:forEach>
