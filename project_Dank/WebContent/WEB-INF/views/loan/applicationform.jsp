<%@ page language="java" contentType="text/html; charset=EUC-KR"
    pageEncoding="EUC-KR"%>
									...
									<div class="card-body ">
										<div class="row">
											...
											<div class="col-10 jumbotron">
												...
												<div class="col-sd-10">
												<input type="number" class="form-control" id="amount" placeholder="희망금액">
												</div>
		...
		<div class="col-sm-6 col-md-2"></div>
			...
			<p class="text-center"><button type="button" class="btn btn-info" onclick="location='applicationsuccess'">대출 신청</button></p>
		</form>
			</div>
