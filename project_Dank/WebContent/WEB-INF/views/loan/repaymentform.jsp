<%@ page language="java" contentType="text/html; charset=EUC-KR"
									...
									<div class="card-body ">
										<div class="row">
											...
											<div class="col-10 jumbotron">
												...
												<div class="form-group">
													<label for="fee" class="col-sd-2">중도 상환 수수료</label>
													<div class="col-sd-10">
   														<input type="email" class="form-control" id="fee" readonly="readonly" value="선택한 대출 이율">
   													</div>
												</div>
												
												<div class="form-group">
												<label for="amount" class="col-sd-2">대출</label>
												<div class="col-sd-10">
  ...
  <label>
   ...
   전액 상환
												...
												<div class="form-group">
												<label for="repayment" class="col-sd-2">대출 희망 상환액</label>
												<div class="col-sd-10">
												<input type="number" class="form-control" id="repayment" placeholder="희망금액">
												</div>
		...
		<div class="col-sm-6 col-md-2"></div>
			...
			<p class="text-center"><button type="button" class="btn btn-info">상환 신청</button></p>
		</form>
			</div>
