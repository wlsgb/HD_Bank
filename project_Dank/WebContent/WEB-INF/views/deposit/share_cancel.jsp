								...
								<div class="card-body">
										...
										<div class="col-md-9">
											<div class="card full-height">
												<div class="card-body">
													...
													<div class="col-md-4 ml-auto">
														<p class="text-primary"><a href="#">예금 해지 예상 조회</a></p>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="row ">
										<div class="col-md-9">
											<div class="card full-height">
												<div class="card-body">
													<div class="card-title">저축 예금 상품</div>
													<div class="row">
														<div class="card-category">나라사랑 적금</div>
														<div class="col-md-4 ml-auto">
															<button class="btn btn-default">해지하기</button>
														</div>
													</div>								
									...
									<div class="row ">
										<div class="col-md-9">
											<div class="card full-height">
												<div class="card-body">
													<div class="card-title">공유 예금 입출금식 상품</div>
													<div class="row">
														<div class="card-category">슈퍼 공유 적금</div>
														<div class="col-md-4 ml-auto">
															<button class="btn btn-default">해지하기</button>
														</div>
													</div>								
													<div class="flex-1 ml-3 pt-1">
														<h6 class="text-uppercase fw-bold mb-1">가입날짜 : 2020.05.31</h6>
														<h6 class="text-uppercase fw-bold mb-1">계좌번호 : 110-123-78999</h6>
														<h6 class="text-uppercase fw-bold mb-1">잔액 : 5,000,000</h6><br>
														<h6 class="text-uppercase fw-bold mb-1">참가인원 : 2명</h6>
														<p class="text-primary"><a href="#">참가인원 수정</a></p>
													</div>
													<div class="col-md-4 ml-auto">
														<p class="text-primary"><a href="#">예금 해지 예상 조회</a></p>
													</div>
