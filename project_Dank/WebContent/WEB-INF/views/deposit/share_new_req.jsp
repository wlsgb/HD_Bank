									...
									<div class="col-md-10">
										...
										<tbody>
											<tr>
												...
												<div class="row">
													<div class="col-md-5">
														<input type="text" class="form-control input-full" id="" placeholder="Enter Input">
													</div>
												</div>
												</td>
											</tr>
											<tr>
												<th scope="col">상대방 계좌</th>
												<td>
												<div class="row">
												<div class="col-2">
												...
												<td colspan="2">
													<div class="row">
														<div class="col-md-6 ml-auto mr-auto">
															<button class="btn btn-primary" onclick="location='share_new_res'">확인</button>	
														</div>
													</div>
												</td>
											</tr>
