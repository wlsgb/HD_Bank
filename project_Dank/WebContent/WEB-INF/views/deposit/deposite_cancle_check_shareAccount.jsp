...
<!-- 								<div class="card-body"> -->
									<table class="table table-hover">
													...
													<thead>
													<tr><th colspan="2" style="border-style: none;" ><span >공유 예금 입출식 상품</span></th></tr>
													</thead>
													<tbody>
													<tr  >
									...
									<table style="margin-left: 30%;" >
										...
										<tr>
											...
											<td></td>
											<td>
												<button type="button" class="btn btn-info btn-sm" style="margin-left: 20%;">추방</button>
											</td>
										</tr>
									...
									<a href="deposite_cancle"><button type="button" class="btn btn-info ">확인</button></a>
