            ...
            <c:choose>
                <c:when test="${member.mem_email==null }">
                    ...
                    <div class="form-group">
                        ...
                        <input type="button" onclick="location='loginPage'" class="btn btn-primary btn-block"
                               value="로그인"/>
                        <input type="button" onclick="location='memberForm'" class="btn btn-primary btn-block"
                               value="회원가입"/>
                    </div>
                    <!-- 로그인 창 끝 -->
                    <!-- 회원가입 창 시작합니다. -->
