                            ...
                            <div class="row">
                                <div class="col-md-10 col-lg-10">
                                        ...
                                        <c:choose>
                                            <c:when test="${account.saving.sav_code != 0 }">
                                                <tr>
                                                    ...
                                                    <td colspan="2"
                                                        style="border-style: none; width: 140px; font-size: 20px;">${account.saving.sav_name}</td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="form-inline" style="margin-left: 10%;">
                                        <span>입금 계좌번호</span>
                                        <input id="take_ac" name="take_ac" type="text" class="form-control"
                                               style="width: 400px; margin-left: 30px;" placeholder="계좌번호를 입력해주세요"
                                               max="10"/>
                                    </div>
