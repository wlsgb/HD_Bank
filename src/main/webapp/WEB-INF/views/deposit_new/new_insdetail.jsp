                                                        ...
                                                        <div class="numbers">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${ins.qua_code != 0}">
                                                                    <h4 class="card-title">${ins.qualificationVO.qua_minperiod }~${ins.qualificationVO.qua_maxperiod }개월<br/>
                                                                    </h4>
                                                                </c:when>
                                                                <c:when test="${ins.qua_code == 0}">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-7 col-stats">
                                                        <div class="numbers">
                                                            ...
                                                            <h4 class="card-title">${ins.qualificationVO.qua_minmoney }원
                                                                이상<br/></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-7 col-stats">
                                                        <div class="numbers">
                                                            ...
                                                            <h4 class="card-title">연 ${ins.ins_interestrate }% <span
                                                                    class="h6">(${ins.qualificationVO.qua_maxperiod}개월)</span>
                                                            </h4>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <form method="post" action="ins_new">
                                                <input type="hidden" id="ins_code" name="ins_code"
                                                       value="${ins.ins_code }">
