                                                        ...
                                                        <div class="numbers">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${shas.qualificationVO.qua_code != 0}">
                                                                    <h4 class="card-title">
                                                                        만${shas.qualificationVO.qua_minage }
                                                                        ~ ${shas.qualificationVO.qua_maxage }세 개인<br/>
                                                                    </h4>
                                                                </c:when>
                                                                <c:when test="${shas.qualificationVO.qua_code == 0}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <form method="post" action="share_new_req_sequrity">
                                                <input type="hidden" id="shas_code" name="shas_code"
                                                       value="${shas.shas_code }">
                                                <input type="hidden" id="sav_code" name="sav_code"
                                                       value="${shas.savingVO.sav_code }">
