                            ...
                            <div class="col-md-10 col-lg-10">
                                ...
                                <c:if test="${savlist != null}">
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th colspan="4" style="border-style: none;"><span
                                                    class="h2">입출식 예금 상품</span></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach items="${savlist }" var="e">
                                            <form action="cancel_input_info" method="post">
                                                <tr>
                                                    ...
                                                    <td style="width: 400px; border-style: none;">계좌번호
                                                        : ${e.ac_num }</td>
                                                    <td style="border-style: none;">
                                                        <input type="hidden" id="ac_code" name="ac_code"
                                                               value="${e.ac_code }">
