                                    ...
                                    <table class="table mt-1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col-4">
                                                        <button type="button" class="btn btn-primary" id="emailBtn">인증코드
                                                            전송
                                                        </button>
                                                    </div>
                                                </div>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col-4 mt-1" id="codeTarget">
                                                        <button type="button" class="btn btn-primary" id="codeCheck">
                                                            확인
                                                        </button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <input type="password" id="ac_pwd" name="ac_pwd"
                                                               class="form-control input-full" placeholder="(4자리)"
                                                               maxlength="4">
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    <div class="col-6">
                                                        <input type="text" id="ac_name" name="ac_name"
                                                               class="form-control input-full">
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <c:if test="${ins != null }">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <input type="text" id="ins_term" name="ins_term"
                                                                   class="form-control input-full">
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <input type="text" id="ins_putmoney" name="ins_putmoney"
                                                                   class="form-control input-full">
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <th colspan="2">
                                                <div class="row">
                                                    <div class="col-md-4 ml-auto">
                                                        <input type="button" class="btn btn-warning" id="update"
                                                               value="개인정보 수정하기"/>
                                                    </div>
                                                    <div class="col-md-8 ml-auto mr-auto">
                                                        <button type="button" class="btn btn-danger" id="cancel">취소
                                                        </button>
