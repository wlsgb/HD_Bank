                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-8">
                            ...
                            <div class="selectgroup w-100">
                                <label class="selectgroup-item">
                                    <input type="radio" name="term" value="1" class="selectgroup-input"
                                           checked="checked">
                                ...
                                <label>
                                    <input type="number" name="n" min="0" value="0" id="n"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-8">
                            ...
                            <div class="selectgroup w-100">
                                <label class="selectgroup-item">
                                    <input type="radio" name="term2" value="1" class="selectgroup-input"
                                           checked="checked">
                                    <span class="selectgroup-button">년</span>
                                </label>
                                <label class="selectgroup-item">
                                ...
                                <label>
                                    <input type="number" value="0" min="0" name="g" id="g"
                                           class="form-control input-lg">
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-5">
                            <div class="form-group">
                                ...
                                <div class="selectgroup w-100">
                                    <label>
                                        <input type="number" value="0" min="0" name="m" id="m"
                                               class="form-control input-lg">
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <div class="selectgroup w-100">
                                    <label>
                                        <input type="number" value="0" min="0" name="r" id="r"
                                               class="form-control input-lg" step="0.1">
                                    </label>
                                </div>
                            </div>
                        </div>
