                    ...
                    <div class="card-body ">
                        <div class="row">
                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <th>대출명</th>
                                    <td><input type="text" readonly="readonly" name="lp_name"
                                               value="${vo.loanProductVO.lp_name }"></td>
                                </tr>
                                <tr>
                                    <th>대출번호</th>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" readonly="readonly"
                                               value="${vo.loanProductVO.lp_interestrate }"></td>
                                </tr>
                                <tr>
                                    <th>중도상환수수료</th>
                                    <td><input type="text" readonly="readonly" value="${vo.loanProductVO.lp_cancelfee }"
                                               name="lp_cancelfee" id="lp_cancelfee"></td>
                                </tr>
                                <tr>
                                    <th>대출신청액</th>
                                    <td><input type="text" readonly="readonly"
                                               value="${vo.loanApplicationVO.la_hamount }"></td>
                                </tr>
                                <tr>
                                    <th>대출잔액</th>
                                    <td><input type="text" readonly="readonly" value="${vo.loanRepayVO.lr_balance }"
                                               id="repaybal"></td>
                                </tr>
                                <tr>
                                    <th>거치기간</th>
                                    <td><input type="text" readonly="readonly"
                                               value="${vo.loanApplicationVO.la_livingterm }"></td>
                                </tr>
                                <tr>
                                    <th>상환기간</th>
                                    <td><input type="text" readonly="readonly"
                                               value="${vo.loanApplicationVO.la_repayterm }"></td>
                                </tr>
                                <tr>
                                    <th>상환계좌</th>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <p class="text-center">
                                            <button type="button" class="btn btn-lg btn-primary repay"
                                                    value="${vo.lc_num }" onclick="check()">상환하기
                                            </button>
                                        </p>
