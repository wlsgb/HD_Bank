...
<div class="content">
    ...
    <c:choose>
        ...
        <c:when test="${vo.lc_state eq '서류제출대기'}">
            <p class="text-center">
                <button type="button" class="btn btn-info" id="file" value="${vo.lc_num }">서류제출</button>
            </p>
        </c:when>
        <c:when test="${vo.lc_state eq '대출승인'}">
            <p class="text-center">
                <button type="button" class="btn btn-info" id="loanstart" value="${vo.lc_num }">실행하기</button>
            </p>
        </c:when>
        <c:when test="${vo.lc_state eq '실행완료'}">
            <p class="text-center">
                <button type="button" class="btn btn-info" value="${vo.lc_num }">상환하기</button>
            </p>
        </c:when>
        <c:otherwise>
            <p class="text-center">
                <button type="button" class="btn btn-info" id="refile" value="${vo.lc_num }">서류보완</button>
            </p>
        </c:otherwise>
