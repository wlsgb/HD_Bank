                            ...
                            <div class="col-md-8 col-lg-8">
                                <form action="transfer_process" method="post" id="needform">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" style="width: 400px; margin-left: 10%;" name="myac"
                                                id="myac" form="needform">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-inline" style="margin-left: 10%;">
                                            ...
                                            <input type="text" name="yourac" placeholder="입금 계좌 번호" id="inputacval"
                                                   maxlength="10" class="form-control"
                                                   style=" text-align:center; width: 200px;"/>
                                            <select class='form-control' style='width: 140px; margin-left: 0%; '
                                                    id='selectyourname'>
                                                <option>대상이름</option>
                                            </select>
                                            <input type="hidden" name="youracmem" placeholder="멤버코드" id="trmem"
                                                   class="form-control"
                                                   style=" text-align:center; background-color:red; width: 300px;"/>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="selectgroup w-30" style="margin-left: 11%;" id="moneyselect">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="mselect" value="100000"
                                                       class="selectgroup-input">
                                                <span class="selectgroup-button">10만</span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="mselect" value="50000"
                                                       class="selectgroup-input">
                                                <span class="selectgroup-button">5만</span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="mselect" value="30000"
                                                       class="selectgroup-input">
                                                <span class="selectgroup-button">3만</span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="mselect" value="10000"
                                                       class="selectgroup-input">
                                                <span class="selectgroup-button">1만</span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="mselect" value="all"
                                                       class="selectgroup-input">
                                        ...
                                        <div class="form-inline" style="margin-left: 10%;">
                                            ...
                                            <input type="text" name="trmoney" id="trmoney" placeholder="이체 금액"
                                                   class="form-control" style=" text-align:center; width: 360px;"/>
                                        </div>
                                    </div>
                                    <hr class="my-0">
                                    <div class="form-group ">
                                        ...
                                        <div class="form-inline" style="margin-left: 10%;">
                                            ...
                                            <input type="text" name="youracwrite" placeholder="10자 이내" maxlength="10"
                                                   class="form-control" style=" text-align:center; width: 360px;"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-inline" style="margin-left: 10%;">
                                            ...
                                            <input type="text" name="myacwrite" placeholder="10자 이내" maxlength="10"
                                                   class="form-control" style=" text-align:center; width: 360px;"/>
                                        </div>
                                    </div>

                                    <div class="form-group ">
                                        <a href="transfer_auto">
                                            <button type="button" class="btn btn-success  btn-lg"
                                                    style="margin-left: 2%; width: 25%; ">자동이체
                                            </button>
                                        </a>
                                        <input type="button" id="gogonext" value="확인" class="btn btn-success  btn-lg"
                                               style="margin-left: 20%; width: 25%; "/>
