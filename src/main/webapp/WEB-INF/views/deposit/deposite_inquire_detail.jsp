                            ...
                            <div class="col-md-8 col-lg-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <form action="inquire_detail_slct" method="post">
                                        <div class="form-inline">
                                            <label class="col-xs-4">
                                                <input type="date" class="form-control" name="startdate" id="startdate"
                                                       style="width: 50%; margin: 10px;"><span
                                        ...
                                        <button type="submit" class="btn btn-success" style="margin-left: 35%">조회하기
                                        </button>
                                    </form>
                    ...
                    <div class="card-body">
                        <table class="table table-hover">
                            ...
                            <c:forEach var="e" items="${history}">
                                ...
                                <tr class="modalclick" data-toggle="modal" data-id="${e.sp_code}"
                                    data-target="#myModal">
