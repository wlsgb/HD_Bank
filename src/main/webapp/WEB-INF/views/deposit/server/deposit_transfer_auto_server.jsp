...
<c:forEach var="e" items="${atlist }">
    <table border="1" class="table table-bordered">
        ...
        <tr>
            <td>출금통장표시내역</td>
            <td>${e.ata_myacmemo }</td>
            <td>HD</td>
            <td>HD</td>
        </tr>

        <tr>
            <td rowspan="2">입금정보</td>
            <td>입금계좌정보</td>
            <td>${e.ata_yourac }</td>
            <td>받는분</td>
            <td>${e.yourname }</td>
        ...
        <tr>
            <td rowspan="4">자동이체정보</td>
            <td>시작일</td>
            <td>${e.ata_startdate }</td>
            <td>종료일</td>
            <td><!-- ${e.ata_stopdate } -->//</td>
        </tr>
        <tr>
            <td>이체금액</td>
            <td>${e.ata_setmoney }</td>
            <td>이체일자</td>
            <td><!-- ${e.ata_dterm } -->//</td>
        </tr>
        <tr>
