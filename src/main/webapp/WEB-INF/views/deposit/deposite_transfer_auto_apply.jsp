                                ...
                                <form action="transfer_auto_apply_process" method="post">
                                    <div class="form-group">
                                        ...
                                        <select name="ac_num" id="ac_num" class="form-control"
                                                style="width: 360px; margin-left: 10%;">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-inline" style="margin-left: 10%;">
                                            ...
                                            <input type="hidden" name="ata_yourmemcode" placeholder="멤버코드"
                                                   id="atapplymem" class="form-control"
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-inline" style="margin-left: 10%;">
                                            ...
                                            <input type="text" name="ata_setmoney" id="ata_setmoney" placeholder="이체 금액"
                                                   class="form-control"
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-inline" style="margin-left: 10%;">
                                            <input type="date" id="ata_startdate" class="form-control"
                                                   name="ata_startdate"/>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-inline">
                                            ...
                                            <input type="text" name="atayouracmemo" class="form-control"
                                                   placeholder="받는분통장에 쓸 내용" style="text-align: center; width: 300px;"/>
                                        </div>
                                        <div class="form-inline">
                                            <label for="email2">보내는분통장에 쓸 내용</label> <br/>
                                            <input type="text" name="atamyacmemo" class="form-control"
                                                   placeholder="보내는분통장에 쓸 내용"
                                        ...
                                        <div class="form-inline">
                                            ...
                                            <a href="transfer_auto">
                                                <button type="button" class="btn btn-danger "
                                                        style="margin-left: 10%; width: 200px;">취소
                                                </button>
                                            </a>

                                            <input type="button" id="gogonext" class="btn btn-success " value="신청"
