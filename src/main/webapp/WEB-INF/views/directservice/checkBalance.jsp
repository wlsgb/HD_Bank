                                                ...
                                                <td>
                                                    <div class="col-md-12 p-0">
                                                        <input type="text" class="form-control input-full"
                                                               required="required"
                                                               id="ac_num" name="ac_num" placeholder="(-없이 입력)"
                                                               maxlength="10">
                                                    </div>
                                                </td>
                                            </tr>
                                                ...
                                                <td>
                                                    <div class="col-md-12 p-0">
                                                        <input type="password" class="form-control input-full"
                                                               required="required"
                                                               id="ac_pwd" name="ac_pwd" placeholder="(4자리)"
                                                               maxlength="4">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-md-12 p-0">
                                                        <input type="text" class="form-control input-full"
                                                               required="required"
                                                               id="membirth" name="membirth" placeholder="(앞 6자리)"
                                                               maxlength="6">
                                                    </div>
                                                </td>
                                            </tr>
                                ...
                                <c:if test="${history !=null}">
                                    <div class="col-md-7">
                                        <table class="table mt-1">
                                            <thead>
                                            <tr>
                                                <th scope="col" colspan="4" style="text-align: center;">계좌번호
                                                    : ${ac_num }</th>
                                            ...
                                            <tr>
                                                ...
                                                <c:choose>
                                                    <c:when test="${e.dep_money!=null }">
                                                        <td scope="col"><span
                                                                class="text-primary">+ ${e.dep_money }</span></td>
                                                    </c:when>
                                                    <c:when test="${e.wit_money!=null }">
                                                        <td scope="col"><span
                                                                class="text-danger">- ${e.wit_money }</span></td>
                                                    </c:when>
                                                </c:choose>
