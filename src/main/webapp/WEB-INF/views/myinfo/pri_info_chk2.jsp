                            ...
                            <table class="table mt-3">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <input type="text" id="mem_name" name="mem_name"
                                                       value="${memberVO.mem_name}" required="required"
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <input type="text" id="mem_email" name="mem_email"
                                                       value="${memberVO.mem_email}" required="required"
                                                       class="form-control input-full"/>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-12">
                                                <input type="text" id="mem_phn" name="mem_phn"
                                                       value="${memberVO.mem_phn}" required="required"
                                                       class="form-control input-full"/>
                                            </div>
                                        </div>
                                    </td>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <input type="text" id="mem_birth" name="mem_birth"
                                                       value="${memberVO.mem_birth}" maxlength="6" required="required"
                                                       class="form-control input-full"/>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-12">
                                                <input type="text" id="mem_loc" name="mem_loc"
                                                       value="${memberVO.mem_loc}" required="required"
                                                       class="form-control input-full"/>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <th colspan="2">
                                        <div class="row">
                                            <div class="col-md-4 ml-auto">
                                                <button type="button" class="btn btn-warning" id="update">비밀번호 수정하기
                                                </button>
                                            </div>
