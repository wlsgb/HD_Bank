                                                ...
                                                <div class="card-body">
                                                    <ul class="nav nav-pills nav-secondary" id="pills-tab"
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link active" id="pills-home-tab"
                                                               ...
                                                               aria-selected="true">ID조회</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="pills-profile-tab"
                                                               data-toggle="pill" href="#pills-profile"
                                                               role="tab" aria-controls="pills-profile"
                                                               aria-selected="false">비밀번호조회</a>
                                                        </li>
                                                    ...
                                                    <div class="tab-content mt-2 mb-3" id="pills-tabContent">
                                                        <div class="tab-pane fade show active" id="pills-home"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="col-md-9 p-0">
                                                                        <input type="text"
                                                                               class="form-control input-full"
                                                                               id="inputbirth" placeholder="(생년월일)"
                                                                               name="sebirth">
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <br>
                                                            <input type="button" id="idgo" style="text-align: center;"
                                                                   class="btn btn-primary btn-round" value="확인">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="col-md-9 p-0">
                                                                        <input type="text"
                                                                               class="form-control input-full"
                                                                               id="inputbirth1" placeholder="(생년월일)">
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <br>
                                                            <input type="button" id="pwgo" style="text-align: center;"
                                                                   class="btn btn-primary btn-round" value="확인">
