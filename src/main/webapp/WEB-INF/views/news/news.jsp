                        ...
                        <div class="card-body" style="justify-content: center;display: flex;">
                            <ul class="pagination pg-primary">
                                ...
                                <c:if test="${paging.startPage != 1 }">
                                    <li class="page-item">
                                        <a href="goNews?nowPage=${paging.startPage - 1 }&cntPerPage=${paging.cntPerPage}
													&searchType=${paging.searchType }&searchValue=${paging.searchValue}"
                                           class="page-link">&lt;&lt;</a>
                                    </li>
                                </c:if>
                                ...
                                <c:if test="${paging.endPage != paging.lastPage}">
                                    <li class="page-item">
                                        <a href="goNews?nowPage=${paging.endPage+1 }&cntPerPage=${paging.cntPerPage}&searchType=${paging.searchType }&searchValue=${paging.searchValue}"
                                           class="page-link">&gt;&gt;</a>
                                    </li>
                                </c:if>
                            </ul>
